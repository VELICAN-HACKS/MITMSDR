...
from MITMCore.fdlitm import EvilInTheMiddle
...
class ETFConsole(Cmd):
    ...
    def __init__(self, history = []):
        ...
        self.current_config_mode = self.configs["fdl"]["aircommunicator"]
        self.config_mode_string = "fdl/aircommunicator/"
    ...
    def start_mitmproxy(self, plugins):
        mitm_configs = self.configs["fdl"]["mitmproxy"]
        try:
