...
success_string =    "[+] Every package was installed successfully. FDL should be ready to go!\n"
...
core_error     =    "[-] One or more core packages failed to install. FDL is not set up.\n"
